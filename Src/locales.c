...
unsigned char  WDT_ENABLED=1;						 /// Enable for activate independent watch dog timer

int		ethmode = 2;  // 1 LAN 2 WIFI
...
char	*topicroot 	= "TESTING_TF";		// base for ALL topics

#endif


char	*const_SERVER_NTP 	= "0.europe.pool.ntp.org";
char	*const_MAIN_SERVER 	= "\"puertorealsinapse.dyndns.org\",993\r";
